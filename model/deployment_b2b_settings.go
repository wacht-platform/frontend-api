...
type DeploymentB2bSettings struct {
	...
	DefaultWorkspaceCreatorRoleID  uint64            `json:"default_workspace_creator_role_id,string" gorm:"not null"`
	DefaultWorkspaceMemberRoleID   uint64            `json:"default_workspace_member_role_id,string"  gorm:"not null"`
	DefaultOrgCreatorRoleID        uint64            `json:"default_org_creator_role_id,string"       gorm:"not null"`
	DefaultOrgMemberRoleID         uint64            `json:"default_org_member_role_id,string"        gorm:"not null"`
