...
func setupAiRoutes(app *fiber.App) {
	...
	aiGroup.Get("/projects/:project_id/board/items/:item_id/events", h.ListBoardItemEvents)
	...
	aiGroup.Post("/projects/:project_id/board/items/:item_id/journal", h.AppendBoardItemJournal)
