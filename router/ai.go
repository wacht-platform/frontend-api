...
func setupAiRoutes(app *fiber.App) {
	...
	aiGroup.Get("/actors", h.ListActors)
	...
	aiGroup.Get("/projects/:project_id/threads/page", h.ListProjectThreadsPage)
	...
	aiGroup.Get("/board-items/:item_id/detail", h.GetBoardItemDetail)
	aiGroup.Get("/board-items/:item_id/task-workspace", h.ListBoardItemTaskWorkspaceFiles)
	aiGroup.Get("/board-items/:item_id/task-workspace/file", h.GetBoardItemTaskWorkspaceFileContent)
	aiGroup.Post("/board-items/:item_id/update", h.UpdateBoardItem)
	aiGroup.Post("/board-items/:item_id/archive", h.ArchiveBoardItem)
	aiGroup.Post("/board-items/:item_id/unarchive", h.UnarchiveBoardItem)
	aiGroup.Post("/board-items/:item_id/journal", h.AppendBoardItemJournal)
	aiGroup.Get("/threads/:thread_id", h.GetThread)
	aiGroup.Get("/threads/:thread_id/events", h.ListThreadEvents)
	...
	aiGroup.Get("/threads/:thread_id/files/:filename", h.ServeFile)
